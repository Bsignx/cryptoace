    ...
    return (
      ...
      >
        <div className="flex justify-between items-center">
          <h1 className={pageTitleStyles}>Your Portfolio</h1>
        </div>
        ...
        >
          ...
          ></Image>
          <h2>Uhoh, you don't have any wallets yet!</h2>

          <div className="flex gap-4">
            <Button asChild className={btnStyles} variant={"secondary"}>
              <Link href={`/tools/wallets`}>
                <PlusCircle className={btnIconStyles} /> Create Wallet
              </Link>
            </Button>
          </div>
        </div>
