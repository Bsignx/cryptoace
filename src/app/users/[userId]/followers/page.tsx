...
function FollowerCard({ profile }: { profile: Profile }) {
  return (
    <div key={profile.userId} className="flex items-center gap-4">
      <div className="dark:bg-zinc-900 flex gap-4 items-center hover:underline border rounded-lg p-4">
        <Avatar>
...
export default async function FollowersPage({
  ...
  return (
    <div className="space-y-8">
      {followers.length === 0 && (
        <div className="flex flex-col items-center justify-center py-12 gap-8 dark:bg-zinc-900 rounded-xl">
          <Image
